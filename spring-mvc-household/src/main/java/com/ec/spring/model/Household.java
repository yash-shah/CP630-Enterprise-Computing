/** Acting as a Model of the Spring MVC Project
 *  
 */

package com.ec.spring.model;
...
public class Household  implements java.io.Serializable {
	...
	private double distanceToStore;	/*!< Distance to the nearert store */
	private Boolean vegetarian = false;	/*!< is the family a Veg? */
    ...
    */
	public Household(double groceryBill, double adults, double familyIncome, double vehicles, double distanceToStore,
			Boolean vegetarian, double children) {
		super();
